...
//                );
        ...
        //2. Assertion
        softAssert.assertEquals(jsonPath.getString("firstname"),"Jane","firstname uyuşmadı");
        softAssert.assertEquals(jsonPath.getString("lastname"),"Doe","lastname uyuşmadı");
        ...
        softAssert.assertEquals(jsonPath.getString("bookingdates.checkout"),"2019-01-01","checkin uyuşmadı");
